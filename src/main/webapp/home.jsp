...
<body>
<!-- Navbar -->
<nav class="navbar fixed-top navbar-expand-lg navbar-dark white scrolling-navba mau" th:fragment="navbar">
    <div class="container">
...
<!--Carousel Wrapper-->
<div id="carousel-example-1z" class="carousel slide carousel-fade pt-4" data-ride="carousel" style="margin-top: 35px">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active">
            <div class="view" style="background-image: url('./assets/slide1.jpg'); background-repeat: no-repeat; background-size: cover;">
        ...
        <div class="carousel-item ">
            <div class="view" style="background-image: url('./assets/slide1.jpg');  background-size: cover;">
